\begin{titlepage}
    ...
    \leavevmode
    \leaders\hrule height -.3ex depth \dimexpr
    .3ex+.4pt\relax % define the leader
    \hskip\glueexpr#1/2\relax\relax % how much it should
    \kern0pt
    }

	\linespread{1.25}
    \newgeometry{hmairgin=2cm, vmargin=1.5cm}
    \fontsize{12pt}{10pt}
	\doublespacing
    \newpage
