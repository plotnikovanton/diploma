...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.62\textwidth}
            \begin{center}
                \includegraphics<1>[width=0.83\textwidth]{energy_loss_euler_1}
                \includegraphics<2>[width=0.83\textwidth]{energy_loss_euler_01}
                \includegraphics<3>[width=0.83\textwidth]{energy_loss_euler_001}
                \includegraphics<4>[width=0.83\textwidth]{energy_loss_euler_0001}
            \end{center}
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        ...
        \begin{column}{0.62\textwidth}
            \begin{center}
                ...
                %\includegraphics<4>[width=0.9\textwidth]{energy_loss_splitted_0001}
            \end{center}
        \end{column}
    \end{columns}
